...
public final class StTLSContext
{
  private static final Logger LOG =
    LoggerFactory.getLogger(StTLSContext.class);

  private final String user;
  private final StConfiguration.TLSStore keyStoreConfiguration;
  private final KeyStore keyStore;
  private final StConfiguration.TLSStore trustStoreConfiguration;
  private final KeyStore trustStore;
  private final SSLContext context;

  private StTLSContext(
    final String inUser,
    final StConfiguration.TLSStore inKeyStoreConfiguration,
    final KeyStore inKeyStore,
    final StConfiguration.TLSStore inTrustStoreConfiguration,
  ...
  public static StTLSContext create(
    final String user,
  ...
  {
    return "[StTLSContext 0x%x]".formatted(Integer.valueOf(this.hashCode()));
  }
