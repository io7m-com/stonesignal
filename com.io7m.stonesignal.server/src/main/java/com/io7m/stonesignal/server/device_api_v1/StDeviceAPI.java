...
/**
 * A device API v1 server.
 */

public final class StDeviceAPI
{
  private static final Logger LOG =
    LoggerFactory.getLogger(StDeviceAPI.class);
    ...
    throws Exception
  {
    ...
    routingBuilder.get(
      ...
      new St1DeviceLocationPut(services)
    );
    routingBuilder.post(
      "/1/0/device-location-put",
      new St1DeviceLocationPut(services)
    ...
    webServer.start();
    LOG.info("[{}] Device API server started", address);
    return webServer;
  }
}
