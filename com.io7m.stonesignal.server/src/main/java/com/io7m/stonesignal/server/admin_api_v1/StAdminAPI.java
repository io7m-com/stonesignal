...
/**
 * An admin API v1 server.
 */

public final class StAdminAPI
{
  private static final Logger LOG =
    LoggerFactory.getLogger(StAdminAPI.class);
    ...
    throws Exception
  {
    ...
    routingBuilder.get(
      "/1/0/device-put",
      new St1AdminHDevicePut(services)
    );
    routingBuilder.post(
      "/1/0/device-put",
      new St1AdminHDevicePut(services)
    ...
    routingBuilder.get(
      ...
      new St1AdminHDeviceGetByID(services)
    );
    routingBuilder.post(
      "/1/0/device-get-by-id",
      new St1AdminHDeviceGetByID(services)
    ...
    routingBuilder.get(
      "/1/0/device-get-by-key",
      new St1AdminHDeviceGetByKey(services)
    );
    routingBuilder.post(
      "/1/0/device-get-by-key",
      new St1AdminHDeviceGetByKey(services)
