...
public interface StTLSContextServiceType
  extends RPServiceType
{
   ...
   *
   * @throws StException On errors
   */

  StTLSContext create(
    String user,
    StConfiguration.TLSStore keyStoreConfiguration,
    StConfiguration.TLSStore trustStoreConfiguration)
    throws StException;
